...
<html>
    ...
    <body>
        ...
        <form action="${pageContext.request.contextPath}/SvMostrarDatos" method="post" class="consulta-form">
            ...
            <select name="accion" id="quincena" required>
                <option value="quincena_Uno">Primera Quincena</option>
                <option value="quincena_Dos">Segunda Quincena</option>           
                <option value="quincena_Tres">Mensual</option>
            </select>
