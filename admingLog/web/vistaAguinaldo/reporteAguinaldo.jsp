    ...
    <body>
        <div class="container">
            ...
            <div class="button-container">
                ...
                <form action="SvAguinaldo" method="POST" style="display: inline;">
                    <input type="hidden" name="accion" value="Ver_Planilla_Empleado">
                    <input type="hidden" name="id_empleado" value="${aguinaldo.colaborador.id_Empleado}">
                    <button type="submit" class="view-planillas-btn">Ver Planilla</button>
                </form>
            </div>
        </div>
    </body>
